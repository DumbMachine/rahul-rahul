...
export default function UploadButton() {
  const { userToken } = useContext(GlobalUserContext);

  const getFiles = () => {
    return axios.get("http://localhost:8000/upload/files", {
      headers: {
...
//   componentDidMount() {
//     const { userToken, setUserToken } = useContext(GlobalUserContext);
